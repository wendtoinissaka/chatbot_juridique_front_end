...
_s(useResizeObserver, "jq6poA/RipA6/BZIsTHdXaoi/oo=");
function Stock({ props: { symbol, price, delta } }) {
    ...
    const xToDate = scaleLinear([
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subMonths"])(new Date(), 6).getTime(),
        new Date().getTime()
    ]);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$14$2e$2$2e$6_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                onPointerDown: (event)=>{
                    if (chartRef.current) {
                        ...
                        setEndHighlight(0);
                        setPriceAtTime({
                            time: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["format"])(new Date(xToDate(clientX)), 'dd LLL yy'),
...
_s1(Stock, "Bssim/wgJnhDu+uB5HMU6CFRXtw=", false, function() {
    return [
